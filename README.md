...
---------------
- **حتما برای کانفیگ تانل های geneve، نخست فایروال ufw را خاموش کنید و پس از اتمام کانفیگ میتوانید روشن نمایید و حتما ufw reload هم بزنید وگرنه کار نمیکند**
- **پس از هر بار ریبوت باید یک بار بر روی هر دو سرور ufw reload بزنید وگرنه تانل کار نخواهد کرد. میتوانید دستور ufw reload را به کرون تب اضافه نمایید**
