...
**۶ روش‌ دیگر هم یعد از امتحان ها کدهاش را مینویسم که یکیش برای گیم است. یک برنامه ساده پورت فوروارد با encryption هم دارم کار میکنم که اگر یه نتیجه برسد قرار میدهم.**
