...
**ریست تایمر برای چندین نوع از لوکال تانل ها و ipsec اضافه شد. لطفا برای ریست تایمر, همزمان تایم مورد دلخواه را وارد نمایید که هم زمان ریست شوند**(بیشتر برای کسانی هست که مشکل قطعی و لیمیت محدود دارند)
