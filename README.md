...
**۶ روش‌ دیگر هم بعد از امتحان ها کدهاش را مینویسم که یکیش برای گیم است. یک برنامه ساده پورت فوروارد با encryption هم دارم کار میکنم که اگر به نتیجه برسد قرار میدهم.**
