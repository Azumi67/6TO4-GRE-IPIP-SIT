...
**اپدیت ویرایش سرور و 10 سرور و ipsec کامل شد- یک آموزش در مورد گزینه ویرایش سرور فردا قرار میدهم**

**محاسبه ریاضی اتوماتیک MTU برداشته شد. از این به بعد خودتان به صورت manual وارد نمایید.**

**در پرایوت ایپی در صورت نگرفتن پینگ، یا mtu را دستی از گزینه edit mtu وارد نمایید یا پس از کانفیگ ریبوت نمایید.**

**تنها GRE6tap و Geneve تستشون مانده است که به زودی تستشون میکنم**
