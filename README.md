...
- امکان تانل ها VXLAN و سایر روش های آ«
...
- تمام تلاشم را کرده ام که در این روش، شما نیاز نباشد که به صورت manual پرفیکس هایی که ایجاد میشود را در سرور اصلی وارد کنید چون نیاز بود که در هنگام کانفیگ بین سرور و کلاینت در گردش باشید. بنابراین در حال حاضر باید نخست سرور خارج را کانفیگ کرد و سپس کلانت های ایران را کانفیگ کرد
...
- ایی رایوت شما نمایش داده میشود و سپس از من سوال میشود که چه تعداد کلاینت ایران دارم. من دو عدد کلاینت ایران دارم پس عدد 2 را وارد میکنم.
...
- از من پرسیده میشود که mtu را به صورت manual وارد میکنید یا خیر. من n را وارد میکنم
- ایی رایوت شما نمایش داده میشود و سپس از من سوال میشود که چه تعداد کلاینت خارج دارم. من دو عدد کلاینت خارج دارم پس عدد 2 را وارد میکنم.
