...
- از تنظیم mtu هم گذر میکنم و سپس تلاش میود که بین دو سرور و کلاینت، اتصال پینگ تست شود
 <p align="right">
...
- سپس مانند قبل چون ورژن ایپی من برای کانفیگ دوم سرور ایران بر اساس 4 بوده است، همان ورژن و ایپی مقابلش را برای کلاینت دوم هم انتخاب میکنم
 <p align="right">
...
- سپس rule ها در فایروال اضافه میشود.
- من در سرور ایران برای کانفیگ دوم از پرایوت ایپی ورژن 4 استفاده کرده بودم پس باید اینجا هم از ایپی ورژن 4 استفاده کنم.
- به طور مثال اگر من ایپی پرایوت 60.1.0.1 را برای کانفیگ دوم سرور ایران وارد کرده بودم پس همیشه برای کلاینت، ایپی مقابل این مقدار را وارد میکنم که میشود 60.1.0.2
- پس ایپی پرایوت کلاینت دوم را انتخاب میکنم
