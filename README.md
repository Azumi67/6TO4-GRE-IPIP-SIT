...
---------------
- **حتما برای کانفیگ تانل های geneve، نخست فایروال ufw را خاموش کنید و پس از اتمام کانفیگ میتوانید روشن نمایید و حتما پس از روشن کردن آن، ufw reload هم بزنید وگرنه کار نمیکند**
- **اگر فایروال روشن دارید، پس از هر بار ریبوت باید یک بار بر روی هر دو سرور ufw reload بزنید وگرنه تانل کار نخواهد کرد. میتوانید دستور ufw reload را به کرون تب اضافه نمایید**
